	...
	<head>
		...
		<script>
			...
			function reloadCaptcha() {
				document.getElementById('captcha').src = "<?php echo base_url('securimage/securimage_show.php?'); ?>" + Math.random(); return false
			}
		</script>
	</head> 
<body>  
...
<?php 
	...
	echo form_input('captcha_code',set_value('captcha_code'),"type='text' size=10 maxlength=6 required");
?>	
	<img id="captcha" src="<?php echo base_url('securimage/securimage_show.php'); ?>" alt="CAPTCHA Image" />
	<a href="#" onclick="reloadCaptcha();">[ Different Image ]</a>
<?php 
