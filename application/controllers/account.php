...
class Account extends CI_Controller {
    ...
    function createNew() {
	    	...
	    	$this->form_validation->set_rules('captcha_code', 'Captcha', "required|callback_captcha_check[$securImgValid]");
	    	$this->form_validation->set_message('captcha_check', 'The Captcha you input is invalid.');
	    	
	    
	    	if ($this->form_validation->run() == FALSE || $securImgValid == FALSE)
	    	{
	    		$data->errormsg = "The captcha you input is invalid";
    ...
    function captcha_check($securImgValid) {
    	return $securImgValid==TRUE;
    }
